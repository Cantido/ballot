defmodule Ballot.ElectionTest do
  ...
  test "returns error when vote types are mixed" do
  ...
  test "returns error when a duplicate vote is added" do
  ...
  test "returns error when a vote has candidates not in the election" do
    election = Ballot.Election.new(["A"])
